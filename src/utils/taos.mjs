// Included in the source https://github.com/versoly/taos/blob/main/src/js/taos.js
// As suggested in https://github.com/versoly/taos/issues/4
  ...
  const refreshTriggers = throttle(() => {
    elements.forEach((el) => {
      el.trigger =
        ...
        window.innerHeight +
        parseInt(el.element.dataset.taosOffset || 0) +
        window.scrollY;
    });
  }, 250);
