...
import merge_options from './_merge-options.png';

<Image src={merge_options} alt="Pull Request Options: Merge, Squash and Rebase" />
...
import merge from './_merge.png';

<Image src={merge} alt="Merge Demo" />
...
import squash from './_squash.png';

<Image src={squash} alt="Squash Demo" />
...
import rebase from './_rebase.png';

<Image src={rebase} alt="Rebase Demo" />
...
import merge_settings from './_merge-settings.png';

<Image src={merge_settings} alt="Merge Settings" />
...
import delete_branch from './_delete-branch.png';

<Image src={delete_branch} alt="Option to delete a branch" />
