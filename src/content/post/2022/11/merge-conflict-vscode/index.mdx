...
Visual Studio Code recently introduced the [three-way merge editor](https://code.visualstudio.com/updates/v1_69?WT.mc_id=MVP_333998#_3-way-merge-editor).

import ex_line from './_ex-line.png';

<Image src={ex_line} alt="Inline Editor" />

This was supposed to replace the old inline editor.

import ex_three_way from './_ex-three-way.png';

<Image src={ex_three_way} alt="Three-way Editor" />
