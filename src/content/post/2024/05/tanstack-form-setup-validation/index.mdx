---
title: 'TanStack Form: Setup and simple validation (with shadcn/ui)'
publishDate: 2024-05-07
image: ./_cover.png
description: "Let's see how to setup a form with TanStack Form using components from shadcn/ui, and add some simple validation rules."
...
<TanStackBanner libraryName="Form" />

## About This tutorial

import form from './_form.png';

<Image src={form} alt="Example Form" />
