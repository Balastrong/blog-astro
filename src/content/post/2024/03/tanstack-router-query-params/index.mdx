...
image: ./_cover.png
description: 'A state manager in the URL, typesafe'
...
In the [first article](/tanstack-router-setup) we saw how to set up a new project with TanStack Router and how to create a couple of routes.

In the [second article](/tanstack-router-path-parameters-loader) instead, the focus was on path parameters and loaders.
...
You can find the full code on [this repository](https://github.com/Balastrong/tanstack-router-demo/) on the [03-query-parameters](https://github.com/Balastrong/tanstack-router-demo/tree/03-query-parameters). Leave a ⭐️ if you found the demo code useful!
