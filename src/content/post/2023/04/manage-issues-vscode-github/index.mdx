...
import new_issue from './_new-issue.png';

<Image src={new_issue} alt="Create a new issue" />
...
import assign_label from './_assign-label.png';

<Image src={assign_label} alt="Assign labels" />
...
import issue_button from './_issue-button.png';

<Image src={issue_button} alt="Open an existing issue" />
