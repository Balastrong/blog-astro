...
import github_extension from './_github-extension.png';

<Image src={github_extension} alt="GitHub Pull Requests and Issues" />
...
import github_extension_icon from './_github-extension-icon.png';

<Image src={github_extension_icon} alt="GitHub Pull Requests and Issues Icon" />
...
import extension_header from './_extension-header.png';

<Image src={extension_header} alt="GitHub Pull Requests and Issues Header" />

If you're already on a pushed branch, this is the panel that will open:

import pr_preview from './_pr-preview.png';

<Image src={pr_preview} alt="GitHub Pull Requests and Issues Preview" />
...
import compare from './_compare.png';

<Image src={compare} alt="Compare panel" />
...
import labels from './_labels.png';

<Image src={labels} alt="Add labels" />
