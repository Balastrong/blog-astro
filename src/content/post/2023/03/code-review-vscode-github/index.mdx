...
import changed_files from './_changed-files.png';

<Image src={changed_files} alt="Changed files" />
...
import pr_overview from './_pr-overview.png';

<Image src={pr_overview} alt="Pull Request Overview" />
...
import ci_status from './_ci-status.png';

<Image src={ci_status} alt="GitHub Actions" />
