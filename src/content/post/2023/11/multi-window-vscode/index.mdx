...
I mean, not that this is a problem, you can get it from the official website [https://code.visualstudio.com/insiders/](https://code.visualstudio.com/insiders/?WT.mc_id=MVP_333998)
